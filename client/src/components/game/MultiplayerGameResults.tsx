        ...
        >
          <div className="inline-flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-white">
              MATCH <span className="text-gold-400">COMPLETE</span>
            </h1>
            <Trophy className="w-8 h-8 text-gold-400" />
          </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <span className={`font-bold ${isWinner ? "text-gold-400" : "text-white"}`}>
                              {player.name}
                            </span>
                            {isCurrentPlayer && (
                              <span className="text-[10px] bg-blue-500/20 text-blue-300 px-1.5 py-0.5 rounded border border-blue-500/30">YOU</span>
                            )}
                          </div>
                      ...
                      <div className="text-right">
                        <div className="font-mono font-bold text-lg">{gameState?.scores?.[player.id] || 0}</div>
